    ...
    <div id="sidebar-nav-container" class="flex-1 space-y-4 overflow-y-auto px-1 py-2 no-scrollbar">
        <div>
            ...
            <nav class="space-y-1 mb-4">
                ...
                <div x-data="{ open: {{ (Request::routeIs('working-shifts.*') || Request::routeIs('employee-working-shifts.*') || Request::routeIs('picket-schedules.*') || Request::routeIs('holidays.*')) ? 'true' : 'false' }} }">
                    <button @click="open = !open" class="menu-item flex items-center justify-between w-full px-3 py-2 rounded-lg text-xs transition-colors relative group
                        {{ (Request::routeIs('working-shifts.*') || Request::routeIs('employee-working-shifts.*') || Request::routeIs('picket-schedules.*') || Request::routeIs('holidays.*')) ? 'bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-slate-50 font-medium' : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-100 hover:bg-slate-50 dark:hover:bg-slate-900/50' }}">
                        <div class="flex items-center gap-3">
                    ...
                    <div x-show="open" x-transition:enter="transition ease-out duration-100" x-transition:enter-start="opacity-0 -translate-y-1" x-transition:enter-end="opacity-100 translate-y-0" x-transition:leave="transition ease-in duration-75" x-transition:leave-start="opacity-100 translate-y-0" x-transition:leave-end="opacity-0 -translate-y-1" class="submenu-list space-y-1 mt-1" style="display: none; padding-left: 2.25rem;">
                        ...
                        <a href="{{ route('picket-schedules.index') }}" class="flex items-center justify-between gap-2 px-3 py-1.5 rounded-lg text-xs {{ Request::routeIs('picket-schedules.*') ? 'bg-slate-50 dark:bg-slate-900/40 text-slate-800 dark:text-slate-200 font-medium' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-50/50 dark:hover:bg-slate-900/30 hover:text-slate-900 dark:hover:text-slate-100' }}">
                            <div class="flex items-center gap-2.5">
                                <span class="w-1 h-1 rounded-full {{ Request::routeIs('picket-schedules.*') ? 'bg-slate-900 dark:bg-slate-50' : 'bg-slate-300 dark:bg-slate-700' }} shrink-0"></span>
                                <span>Jadwal Piket</span>
                            </div>
                            <span class="text-[9px] font-bold px-1.5 py-0.2 rounded bg-indigo-50 dark:bg-indigo-950 text-indigo-600 dark:text-indigo-400 border border-indigo-200/50 dark:border-indigo-800/50">Unit</span>
                        </a>
            ...
            <h3 class="school-info px-2 text-xs font-semibold text-slate-400 dark:text-slate-500 uppercase tracking-wider mb-2 mt-4">SETTING SYSTEM</h3>
            <nav class="space-y-1 mb-4">
                ...
                <a href="{{ route('raw-attendance-logs.index') }}" class="menu-item flex items-center gap-3 px-3 py-2 rounded-lg
                    ...
                    <span class="menu-text">Log Absensi</span>
                    <span class="sidebar-tooltip absolute left-full ml-3 px-2 py-1 bg-slate-900 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-slate-50 dark:text-slate-100 text-xs font-semibold rounded-md shadow-md opacity-0 scale-95 group-hover:opacity-100 group-hover:scale-100 transition-all origin-left duration-100 pointer-events-none whitespace-nowrap z-50">
                        Log Absensi
                    </span>
                </a>
                ...
                <a href="{{ route('settings.index') }}" class="menu-item flex items-center gap-3 px-3 py-2 rounded-lg
                    ...
                    <span class="menu-text">Setting App</span>
                    <span class="sidebar-tooltip absolute left-full ml-3 px-2 py-1 bg-slate-900 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-slate-50 dark:text-slate-100 text-xs font-semibold rounded-md shadow-md opacity-0 scale-95 group-hover:opacity-100 group-hover:scale-100 transition-all origin-left duration-100 pointer-events-none whitespace-nowrap z-50">
                        Setting App
                    </span>
                </a>
                <a href="{{ route('system-logs.index') }}" class="menu-item flex items-center gap-3 px-3 py-2 rounded-lg
                    {{ Request::routeIs('system-logs.*') ? 'bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-slate-50 font-medium' : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-100 hover:bg-slate-50 dark:hover:bg-slate-900/50' }}
                    text-xs relative group">
                    <i data-lucide="file-text" class="menu-icon w-4 h-4"></i>
                    <span class="menu-text">Log System</span>
                    <span class="sidebar-tooltip absolute left-full ml-3 px-2 py-1 bg-slate-900 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-slate-50 dark:text-slate-100 text-xs font-semibold rounded-md shadow-md opacity-0 scale-95 group-hover:opacity-100 group-hover:scale-100 transition-all origin-left duration-100 pointer-events-none whitespace-nowrap z-50">
                        Log System
                    </span>
                </a>
