    ...
    <div class="p-6 space-y-6 w-full">
        ...
        <header class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 w-full text-left">
            <div class="flex flex-col gap-0.5">
                ...
                <h2 class="text-2xl font-bold tracking-tight text-slate-900 dark:text-slate-550">Tulis Pengumuman Baru</h2>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-4 gap-6 text-left">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex items-center pt-2">
                            ...
                            <label for="is_active" class="ml-2 block text-xs font-semibold text-slate-700 dark:text-slate-350 cursor-pointer">Langsung Aktifkan & Terbitkan</label>
                        </div>
                    </div>
                </div>
